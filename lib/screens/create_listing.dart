...
class _CreateListing extends State<CreateListing> {
  ...
  String date_listed = DateFormat("dd, MMM, yyyy").format(
      DateTime.now()); // stores the time of uploading the item on the database.
  ...
  String? selectedCategory; // this variable store
...
//this is used to get the uid for the logged in user
  ...
  postDetailsToFirestore(String imageURl) async {
    ...
    userListing.Listing_time = date_listed;
